...
class UpdatePickupSettingRequest extends FormRequest
{
    /**
    ...
    {
        $settingId = $this->route('pickup_setting') ? $this->route('pickup_setting') : $this->route('id');
        ...
        return [
            ...
            'jarak_max' => [
                ...
                function ($attribute, $value, $fail) use ($settingId) {
                    $this->validateRangeOverlap($attribute, $value, $fail, $settingId);
                }
            ],
            'biaya' => [
                'required',
    ...
    /**
     * Validate range overlap for same service type (excluding current record)
     */
    private function validateRangeOverlap($attribute, $value, $fail, $settingId)
    {
        ...
        // Check for overlap with same service type ONLY, excluding current record
